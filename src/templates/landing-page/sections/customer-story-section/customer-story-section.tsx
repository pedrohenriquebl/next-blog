...
const customerStories = [
    ...
    {
        content: 'Transformar minha ideia em uma loja online foi fácil e rápido. Adorei as opções de personalização' + 
        'e a simplicidade para gerenciar os pedidos. Já vejo meus produtos alcançando mais pessoas!',
        author: {
            name: 'Jacob Jones',
            role: 'CEO na JJ Org',
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    {customerStories.map((customerStory) => (
                        <div key={customerStory.author.name}
                            ...
                            <p className="text-balance text-gray-200 font-style: italic font-light">
